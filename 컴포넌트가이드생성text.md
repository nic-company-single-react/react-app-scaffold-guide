src/domains/example/pages/ui-components/ 폴더에 Button Group 컴포넌트에 대한 예제 화면을 만들어줘.
참조해서 만들 화면은 같은 폴더 내에 있는 AccordionComponent.tsx 파일을 참조하면 되고, Button Group 컴포넌트의 실제 코드는 C:\redsky\work\react\single_react_new_nicfirst\react-app-scaffold\src\shared\lib\shadcn\ui\button-group.tsx 파일을 파악하면 된다.
